...
/***
 * Handler class for persisted entity "contentActionAssignments" of service "CatalogService".
 ...
 */
public class contentActionAssignmentsHooksHandler {
...
//	@BeforeRead(entity = "contentActionAssignments", serviceName = "CatalogService")
//	public BeforeReadResponse beforeReadcontentActionAssignments(ReadRequest req, ExtensionHelper helper) {
...
//	@AfterRead(entity = "contentActionAssignments", serviceName = "CatalogService")
//	public ReadResponse afterReadcontentActionAssignments(ReadRequest req, ReadResponseAccessor res, ExtensionHelper helper) {
...
//	}
	...
	@BeforeQuery(entity = "contentActionAssignments", serviceName = "CatalogService")
...
//	@AfterQuery(entity = "contentActionAssignments", serviceName = "CatalogService")
//	public QueryResponse afterQuerycontentActionAssignments(QueryRequest req, QueryResponseAccessor res, ExtensionHelper helper) {
...
//	}
	...
	@BeforeCreate(entity = "contentActionAssignments", serviceName = "CatalogService")
...
//	@AfterCreate(entity = "contentActionAssignments", serviceName = "CatalogService")
//	public CreateResponse afterCreatecontentActionAssignments(CreateRequest req, CreateResponseAccessor res, ExtensionHelper helper) {
//		//TODO: add your custom logic / validations here...
//
...
//	@BeforeUpdate(entity = "contentActionAssignments", serviceName = "CatalogService")
//	public BeforeUpdateResponse beforeUpdatecontentActionAssignments(UpdateRequest req, ExtensionHelper helper) {
...
//	@AfterUpdate(entity = "contentActionAssignments", serviceName = "CatalogService")
//	public UpdateResponse afterUpdatecontentActionAssignments(UpdateRequest req, UpdateResponseAccessor res, ExtensionHelper helper) {
//		//TODO: add your custom logic / validations here...
//
//		return res.getOriginalResponse(); //use this API if operation succeeded and payload has not been modified.
...
//	@BeforeDelete(entity = "contentActionAssignments", serviceName = "CatalogService")
//	public BeforeDeleteResponse beforeDeletecontentActionAssignments(DeleteRequest req, ExtensionHelper helper) {
//		//TODO: add your custom logic / validations here...
//
...
//	@AfterDelete(entity = "contentActionAssignments", serviceName = "CatalogService")
//	public DeleteResponse afterDeletecontentActionAssignments(DeleteRequest req, DeleteResponseAccessor res, ExtensionHelper helper) {
//		//TODO: add your custom logic / validations here...
//
//		return res.getOriginalResponse(); //use this API if operation succeeded and payload has not been modified.
